...
import { AudioPlayerFactory, AudioSource, PlayerEventType } from '@tunein/audio-player';
    ...
    <div className="multi-station-player">
      ...
      <div className="station-list">
        {stations.map((station, index) => (
          <button key={index} onClick={() => switchStation(index)} className={currentStation === index ? 'active' : ''}>
            {station.url}
          </button>
        ))}
      </div>
...
export const AdvancedRadioPlayer = () => {
  ...
  return (
    <div className="advanced-player">
      ...
      <AudioPlayerComponent player={playerState} showVolume={true} showState={true} />
